...
export class AddPosting extends Component<any>{
    render(): JSX.Element {
        return (
            <Card>
                <CardContent>
...
export type AddPostingProps = WithStyles<typeof styles>

export default withStyles(styles, {withTheme: true})(AddPosting)